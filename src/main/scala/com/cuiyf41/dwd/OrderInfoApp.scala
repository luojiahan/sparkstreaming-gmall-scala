...
import com.cuiyf41.bean.{OrderInfo, ProvinceInfo, UserInfo, UserStatus}
import com.cuiyf41.util._
  ...
  def main(args: Array[String]): Unit = {
    ...
    val orderInfoWithFirstFlagDStream: DStream[OrderInfo] = orderInfoDStream.map {
      orderInfo => {
        ...
        var sql: String = s"select user_id,if_consumed from user_status where user_id='${userId}'"
